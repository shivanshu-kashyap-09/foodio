...
const SouthIndian = ({ southDish }) => {
  ...
  const displayItems = useMemo(() => {
    if (!Array.isArray(southDish)) return [];
    
    let filtered = southDish.map(dish => ({
      ...dish,
    ...
    return filtered;
  }, [southDish, searchQuery, activeFilters]);
    ...
    <div className="py-12 sm:py-20 bg-orange-50/30 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {!searchQuery && displayItems.length > 8 && (
          ...
          >
            <button className="group flex items-center gap-4 px-10 py-5 bg-white border-2 border-orange-100 rounded-full font-black text-xs uppercase tracking-widest text-gray-600 hover:border-orange-600 hover:text-orange-600 transition-all shadow-sm">
